...
// Button Click Events
repo_create_btn.onclick = () => {       // Repo-Create
    // Validate Input
...
repo_list_btn.onclick = () => {         // Repo-List Button
    // Proceed with Request
    ...
    fetch(`http://${IP}:${PORT}/list_repositories`)
        ...
        .then(data => {
            ...
            // Success
                ...
                if(PRIORITY_MSG) {              // Check for High Priority Msg
...
repo_list.onclick = () => {             // Repo List Selection
...
submit_key.onclick = () => {            // Submit SSH Public Key
